...
def test_configuration_loading():
    ...
    try:
        ...
        print(f"  OK: Hotkey enabled: {hotkey_config['hotkey_settings'].get('enabled')}")
        print(f"  OK: Direct hotkeys count: {len(hotkey_config['direct_hotkeys'])}")
        print(f"  OK: Sequence hotkeys count: {len(hotkey_config.get('sequence_hotkeys', {}))}")
...
def main():
    ...
    if passed == total:
        ...
        print("  Direct shortcuts: Ctrl+Shift+L (lowercase), Ctrl+Shift+U (uppercase), etc.")
