...
class DaemonModeRefactored:
    ...
    def start_monitoring(self) -> None:
        ...
        try:
            ...
            if not hasattr(self._clipboard_monitor, '_active_rules') or not self._clipboard_monitor._active_rules:
    ...
    def _display_stop_statistics(self) -> None:
        ...
        print(f"[DAEMON] Sequences detected: {hotkey_stats.get('sequences_detected', 0)}")