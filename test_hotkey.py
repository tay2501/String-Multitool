...
from string_multitool.exceptions import ValidationError, ConfigurationError
...
class TestHotkeyMode:
    ...
    def test_initialization_invalid_transformation_engine(self, mock_dependencies):
        ...
        with pytest.raises(ValidationError, match="Transformation engine cannot be None"):
    ...
    def test_initialization_invalid_config_manager(self, mock_dependencies):
        ...
        with pytest.raises(ValidationError, match="Configuration manager cannot be None"):
...
class TestHotkeyIntegration:
    ...
    def test_load_real_hotkey_config(self, real_config_manager, mock_other_dependencies):
        """Test loading real hotkey configuration."""
        io_manager, transformation_engine = mock_other_dependencies
        
        try:
            hotkey_mode = HotkeyMode(io_manager, transformation_engine, real_config_manager)
