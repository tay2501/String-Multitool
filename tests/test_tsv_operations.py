...
class TestTSVOperationsCore:
    ...
    def test_tsv_list_command_execution(self, transformation_engine: TextTransformationEngine) -> None:
    ...
    def test_tsv_sqlite3_command_execution(self, transformation_engine: TextTransformationEngine) -> None:
    ...
    def test_tsv_missing_arguments_error(self, transformation_engine: TextTransformationEngine) -> None:
    ...
    @pytest.mark.parametrize("rule_string,expected_result", [
...
class TestTSVOperationsPerformance:
    ...
    def test_list_command_performance(self, transformation_engine: TextTransformationEngine) -> None:
        ...
        assert execution_time < self.LIST_COMMAND_THRESHOLD, (
    ...
    def test_sqlite_command_performance(self, transformation_engine: TextTransformationEngine) -> None:
    ...
    def test_rule_parsing_performance(
        ...
        assert average_time < self.PARSING_THRESHOLD, (
