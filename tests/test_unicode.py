...
class TestUnicodeHandling:
    ...
    @pytest.mark.parametrize("test_input,rule,description", [
    ...
    def test_unicode_pipe_subprocess(self) -> None:
        ...
        test_input = " Te Sｔ- _　  "
        expected_output = test_input.strip()
        ...
        try:
            ...
            assert actual_output == expected_output, (
                f"Unicode pipe test failed: expected {repr(expected_output)}, got {repr(actual_output)}"
            )
